# Contrato do Ciclo 5 — Write Preparation — JSON Strict — Modelo 0A/0B
...
Os `success_criteria` devem ser objetivos e verificáveis. Exemplos válidos:
- "cache hit rate > 40% em 100 interações observadas"
- "rota Anthropic aparece em >= 1 entrada de route_logs em 24h"
Exemplos inválidos:
- "funciona melhor"
- "parece adequado"
...
- cycle5_contract_json_strict.md existe
