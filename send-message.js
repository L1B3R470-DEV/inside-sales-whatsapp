...
var TOPOLOGY = {
  operationalHostRole: $env.ATTENDANT_OPERATIONAL_HOST_ROLE || 'PC_CLS',
  operationalHostIp: $env.ATTENDANT_OPERATIONAL_HOST_IP || '100.113.13.27',
  operationalDockerHostRole: $env.ATTENDANT_OPERATIONAL_DOCKER_HOST_ROLE || 'PC_CLS',
  operationalDockerHostIp: $env.ATTENDANT_OPERATIONAL_DOCKER_HOST_IP || '100.113.13.27',
  interactiveHostRole: $env.ATTENDANT_INTERACTIVE_HOST_ROLE || 'PC_LBN',
  interactiveHostIp: $env.ATTENDANT_INTERACTIVE_HOST_IP || '100.101.106.95',
  interactiveModeOnly: String($env.ATTENDANT_INTERACTIVE_MODE_ONLY || 'true').toLowerCase() === 'true',
  rejectLbnAsRuntime: String($env.ATTENDANT_REJECT_LBN_AS_RUNTIME || 'true').toLowerCase() === 'true',
  rejectLbnDocker: String($env.ATTENDANT_REJECT_LBN_DOCKER || 'true').toLowerCase() === 'true'
};
